defmodule Hangman.Pass.Test do
  ...
  def julio_asparagus_9_game3 do
    ...
    {^pass_key, ^pass_info} = Pass.result(:start, pass_key, reduce_key)
    ...
    assert ~r/^[^e]*$/ = Reduction.Options.regex_match_key(context, guessed)
    ...
    {^pass_key, ^pass_info} = Pass.result(:guessing, pass_key, reduce_key)
    ...
    possible_txt =
      "Possible hangman words left, 6 words: [\"abradants\", \"adiabatic\", \"aplanatic\", \"apparatus\", \"aquanauts\", \"asparagus\"]"
    ...
    assert ~r/^[^n]*$/ = Reduction.Options.regex_match_key(context, guessed)
    ...
    possible_txt =
      "Possible hangman words left, 3 words: [\"adiabatic\", \"apparatus\", \"asparagus\"]"
    ...
    assert ~r/^[^b]*$/ = Reduction.Options.regex_match_key(context, guessed)
  ...
  def julio_voluptuous_10_game2 do
    ...
    assert ~r/^[^i]*$/ = Reduction.Options.regex_match_key(context, guessed)
    ...
    assert ~r/^[^a]*$/ = Reduction.Options.regex_match_key(context, guessed)
    ...
    possible_txt =
      "Possible hangman words left, 11 words: [\"combustors\", \"compulsory\", \"conclusory\", \"conductors\", \"consultors\", \"corruptors\", \"nonsupport\", \"polychromy\", \"polygynous\", \"posthumous\", \"voluptuous\"]"
    ...
    assert ~r/^[^c]*$/ = Reduction.Options.regex_match_key(context, guessed)
    ...
    assert ~r/^[^g]*$/ = Reduction.Options.regex_match_key(context, guessed)
  ...
  def julio_cumulate_8_game1(tag \\ "") when is_binary(tag) do
    ...
    assert ~r/^[^o]*$/ = Reduction.Options.regex_match_key(context, guessed)
    ...
    possible_txt =
      "Possible hangman words left, 13 words: [\"bunkmate\", \"cumulate\", \"cupulate\", \"fluxgate\", \"jugulate\", \"lunulate\", \"pyruvate\", \"scyphate\", \"subulate\", \"sufflate\", \"sulphate\", \"undulate\", \"ungulate\"]"
    ...
    possible_txt =
      "Possible hangman words left, 7 words: [\"cumulate\", \"cupulate\", \"jugulate\", \"subulate\", \"sufflate\", \"undulate\", \"ungulate\"]"
