...
defmodule Hangman.Counter.Test do
  ...
  describe "counter crud" do
    
    test "create with string and use" do
    ...
    test "create with tuple and use" do
  ...
  describe "add data and generate tally" do

    test "add unique letters and tally" do
    ...
    test "add non-unique letters and tally" do
