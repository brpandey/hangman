defmodule Hangman.Game.Server.Test do
  ...
  test "rabbit1 - double games - cumulate avocado", context do
    ...
    assert %{key:  {{"rabbit", 1}, 1, 9}, result: :correct_word, code: :won, 
     ...
     Game.Server.guess(game_pid, player_key, {{"rabbit", 1}, 1, 9}, {:guess_word, "cumulate"})
    ...
    assert %{key:  {{"rabbit", 1}, 2, 7}, result: :correct_word, code: :won, 
      ...
      Game.Server.guess(game_pid, player_key, {{"rabbit", 1}, 2, 7}, {:guess_word, "avocado"})
  ...
  test "rabbit2 - single game - eruptive", context do
    ...
    assert %{key:  {{"rabbit", 2}, 1, 6}, result: :correct_word, code: :won, 
     ...
     Game.Server.guess(game_pid, player_key, {{"rabbit", 2}, 1, 6}, {:guess_word, "eruptive"})
