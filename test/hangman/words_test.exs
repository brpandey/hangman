defmodule Hangman.Words.Test do
  ...
  describe "Words creation" do
    ...
    test "small streams new" do
      # Take four items
      stream = @words_small |> Stream.take(4)
  ...
  describe "Words read" do
    test "collect small" do
      ...
      assert ["azole", "azons", "azote", "azoth"] = Words.new(5, stream) |> Words.collect(4)
    end
    ...
    test "collect big" do
      ...
      # grab first 4 words and then sort the list alphabetically
      assert ["atman", "atmas", "atoll", "atoms"] = Words.new(5, stream) |> Words.collect(4)
    end
  end
  ...
  describe "Words filter" do
    test "filter simple match no o" do
      ...
      assert ["axles", "axman", "axmen", "ayahs", "ayins", "azans", "azide", "azine"] = list
    end
    ...
    test "filter complex pattern match" do
      ...
      assert ["blubs", "bluff", "blunt", "blurb", "blurs", "blurt", "blush", "brugh"] = list
    end
  end
