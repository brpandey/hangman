defmodule Hangman.Application do
  ...
  it in all its correct positions. If the suggested letter or number does not occur in 
  the word, the other player draws one element of a hanged man stick figure as a tally mark.
  ...
  Otherwise, the other player may choose to penalize the guesser by adding an element 
  to the diagram. On the other hand, if the other player makes enough incorrect 
  guesses to allow his opponent to complete the diagram, the game is also over, this 
  time with the guesser losing. However, the guesser can also win by guessing all 
  the letters or numbers that appears in the word, thereby completing the word, 
  before the diagram is completed.
  ...
  NOTE: The game implementation of Hangman above has removed the ability to guess the word at any time.
  Only at the end is this possible. No visual depiction of a man is drawn, simply
  the word represented by a row of dashes.
